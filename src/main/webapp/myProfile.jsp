                ...
                <c:choose>
                    <c:when test="${param.error == '1'}">
                        <div class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded">
                            Please make your username 4 letters or longer!
                        </div>
                    </c:when>
    ...
    <c:choose>
        <c:when test="${not empty user.profilePicture}">
            ...
            <div class="flex justify-center">
                <img src="${user.profilePicture}" alt="Profile Picture" class="w-32 h-32 rounded-full object-cover">
            </div>
        </c:when>
        <c:otherwise>
                ...
                <i class="fas fa-user-circle text-9xl text-gray-600 mb-4"></i>
                            ...
                            <div class="border-b pb-4">
																...
																<div class="flex items-center">
																		...
																		<button onclick="togglePassword()" class="ml-2 text-blue-600 hover:text-blue-800">
                    ...
                    <c:if test="${param.edit != null}">
                        ...
                        <div>
                            <label for="passwordConfirm" class="block text-sm font-medium text-gray-700">Confirm New Password</label>
