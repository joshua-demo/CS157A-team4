...
<body class="bg-gray-100 font-sans">
    ...
    <div class="container mx-auto p-6">
        ...
        <div class="modal opacity-0 pointer-events-none fixed w-full h-full top-0 left-0 flex items-center justify-center">
            ...
            <div class="modal-container bg-white w-11/12 md:max-w-md mx-auto rounded shadow-lg z-50 overflow-y-auto">
                <div class="modal-content py-4 text-left px-6">
                    ...
                    <!-- Modal Body -->
                    <form action="UAddCourse" method="post" class="space-y-4" onsubmit="setTimeout(refreshCourses, 1000)">
                        <div>
                        ...
                        <div class="flex justify-end pt-2">
                            <button type="submit" 
                                    class="px-4 bg-blue-500 p-3 rounded-lg text-white hover:bg-blue-400">Add Course</button>
                        </div>
                    </form>
                </div>
            </div>
        ...
        <c:if test="${empty courseList}">
            <p class="text-gray-600">No courses found. Add a new course to get started!</p>
        </c:if>
