...
<body class="bg-gray-100 font-sans">
		...
		<div class="container mx-auto p-6">
			<h1 class="text-3xl font-bold text-gray-800 mb-6">My Study Sessions</h1>
			...
			<div class="grid grid-cols-1 md:grid-cols-3 gap-6">
					<div class="bg-white rounded-lg shadow-md p-6">
							<h3 class="text-lg font-semibold text-gray-700 mb-2">Total Hours</h3>
							<p class="text-3xl font-bold text-blue-500" id="totalHours">0</p>
					</div>
					<div class="bg-white rounded-lg shadow-md p-6">
							<h3 class="text-lg font-semibold text-gray-700 mb-2">Average Hours/Day</h3>
							<p class="text-3xl font-bold text-green-500" id="avgHours">0</p>
					</div>
					<div class="bg-white rounded-lg shadow-md p-6">
							<h3 class="text-lg font-semibold text-gray-700 mb-2">Most Productive Day</h3>
