...
<nav class="bg-blue-600 p-4 shadow-md">
    <div class="container mx-auto flex justify-between items-center">
        ...
        <div class="flex items-center">
            ...
            <a href='<%= request.getServletPath().equals("/mainPage.jsp") ? "mainPage.jsp" : "homePage.jsp" %>' 
        ...
        <% if (session.getAttribute("user") != null) { %>
            <div class="flex items-center space-x-4">
                ...
                <a href="myStudySessions.jsp" class="text-white hover:text-blue-200">Study Sessions</a>
                <a href="myExtracurriculars.jsp" class="text-white hover:text-blue-200">Extracurriculars</a>
            </div>
        ...
        <div class="flex items-center space-x-4">
            <% if (session.getAttribute("user") != null) { %>
                ...
                <form action="ULogout" method="post" class="inline-block">
                    <button type="submit" class="text-white hover:text-blue-200 focus:outline-none">
                        Logout
                    </button>
                </form>
            <% } else { %>
                <a href="loginPage.jsp" class="px-4 py-2 bg-white text-blue-600 rounded-md hover:bg-blue-50 transition duration-300">Login</a>
                <a href="userRegister.jsp" class="px-4 py-2 bg-transparent text-white border border-white rounded-md hover:bg-blue-700 transition duration-300">Register</a>
            <% } %>
        </div>
    </div>
</nav>